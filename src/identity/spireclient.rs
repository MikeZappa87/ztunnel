...
use crate::{identity::{ CompositeId, PidClientTrait, RequestKeyEnum}, inpod::WorkloadPid, tls::{self}};
...
impl SpireClient {
    pub fn new(client: DelegatedIdentityClient, trust_domain: String, pid: Box<dyn PidClientTrait>) -> Result<SpireClient, Error> {
        Ok(SpireClient { client, trust_domain, pid })
    }
